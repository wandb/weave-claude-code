...
// team_name, and transcript_path (the teammate's, not the coordinator's). The
// integration test below drives this payload through the daemon to catch any
// regression in field-name reading.
